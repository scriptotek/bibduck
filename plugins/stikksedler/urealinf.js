$.extend($.bibduck.stikksedler, {
    ...
    reg_no: function (doc, user, library) {
        var excel = this.load_xls('plugins/stikksedler/urealinf/reg_no.xls');
    ...
    reg_en: function (doc, user, library) {
        var excel = this.load_xls('plugins/stikksedler/urealinf/reg_en.xls');
        this.template_replacements(doc, user, library, excel);
    ...
    ret_en: function(doc, user, library) {
        var excel = this.load_xls('plugins/stikksedler/urealinf/ret_en.xls');
        this.template_replacements(doc, user, library, excel);
        this.print_and_close();
    },

    ret_no: function(doc, user, library) {
        var excel = this.load_xls('plugins/stikksedler/urealinf/ret_no.xls');
        this.template_replacements(doc, user, library, excel);
        this.print_and_close();
    }
